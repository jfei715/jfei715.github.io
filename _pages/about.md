...
------
* Indirect estimation of gait propulsion (anterior ground reaction forces) using clinically accessible variables from routine assessments and Inertial Measurement Units (IMUs).
